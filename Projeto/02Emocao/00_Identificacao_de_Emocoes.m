...
porc= 78/90;     %Porcentagem (86,67%) da quantidade de audios usada para gerar o MFCC. O restante será usado para teste da rede
...
MFCC_tipo=2;    %Se:
                ...
                %MFCC_tipo=3 => Gera MFCC_MEDC medio de cada palavra
...
save('Emocoes_Entradas.mat','N_framing','M_framing','N_mel','mfcc_size','num_loc','num_voz','num_emoc','porc');
%%%%%%%%%%%%%%%%%%%%%%
...
if      MFCC_tipo==2
Gera_Emocoes %Chama a rotina
end
if      MFCC_tipo==3 
Gera_Emocoes_MFCC_MEDC %Chama a rotina
end
...
if Classificador==1
Emocoes_MultipleNeuralNet
end
if Classificador==2
   Emocoes_MultipleNeuralNet  %Chama o programa que gera a Rede Neural
end
if Classificador==3
   Emocoes_MultipleNeuralNet_MEDC  %Chama o programa que gera a Rede Neural
end
if Classificador==4
...
if Classificador==1
Emocoes_TesteDaRede_MultipalNeuralNet
end
if Classificador==2
   Emocoes_TesteDaRede_MultipalNeuralNet %Chama a rotina
end
if Classificador==3
   Emocoes_TesteDaRede_MultipalNeuralNet_MEDC %Chama a rotina
end
if Classificador==4
