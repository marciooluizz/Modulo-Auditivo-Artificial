...
%mfcc_medc_size=mfcc_size+length(Difference1)+length(Difference2)+length(Delta)+length(Delta_Delta);
mfcc_e_medc = [mfcc,Delta,Delta_Delta,Difference1,Difference2];
mfcc_medc_size = length(mfcc_e_medc);
